...
class Triangle(object):
    ...
    def area(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        sideab = self.a.distance_from(self.b)
        sidebc = self.b.distance_from(self.c)
        sideca = self.c.distance_from(self.a)
        #
...
def run_test_return_doubled_triangle():
    ...
    expected_a = Point(0, 2)
    expected_b = Point(4, 6)
    expected_c = Point(8, 10)
    run_test_instance_variables(t2, expected_a, expected_b, expected_c)
    ...
    expected_a = Point(0, 4)
    expected_b = Point(6, 6)
    expected_c = Point(10, 10)
    run_test_instance_variables(t2, expected_a, expected_b, expected_c)
